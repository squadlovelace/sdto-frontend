...
import HeaderReceptor from '../../HeaderReceptor/headerReceptor';
          ...
          <div className="container  grid-cols-8 mx-auto pt-5">
            <form onSubmit={addUser}>
              <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <div className="w-full md:w-1/2  pt-2 px-3 grid-cols-8"></div>
            ...
            <div className="container  grid-cols-8 mx-auto pt-5">
              <form onSubmit={addUser}>
                <div className="flex flex-wrap -mx-3 mb-6 ">
                  ...
                  <button
                    style={{ backgroundColor: '#672557' }}
                    className="flex flex-row justify-center items-center ml-56 gap-2 w-80 h-12 rounded-xl font-text font-normal text-x2 text-white "
                    onClick={() => setStep(3)}
                  >
                    Finalizar Cadastro
                  </button>
