                    ...
                    <form onSubmit={handleSubmit}>   
                        <div className="flex flex-wrap -mx-3 mb-6">
                            <div className="w-full px-3 mb-6 md:mb-0 pt-4">
                                ...
                                <input className="appearance-none block w-full  text-gray-700 border rounded-lg py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name=""id="grid-first-name" type="text" value={formState.razao}onChange={(event)=>setFormState({...formState,razao:event.currentTarget?.value ||""})}placeholder="Digite seu nome"/>
                            </div>
                            <div className="w-full md:w-1/2 px-3 pt-4">
                                <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                <p style={{color:"#672557"}}>CNPJ</p>
                                </label>
                                <input className="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" name="cnpj"placeholder="Digite Seu CNPJ" value={formState.cnpj}onChange={(event)=>setFormState({...formState,cnpj:event.currentTarget?.value ||""})}/>
                                ...
                                <div className="w-full md:w-1/2 pt-4 px-3">
                                    ...
                                    <input className="appearance-none block w-full  text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" value={formState.cep}onChange={(event)=>setFormState({...formState,cep:event.currentTarget?.value ||""})} placeholder="Digite o CEP"/>
                                ...
                                <div className="w-full md:w-1/3 pt-4 px-3">
                                    ...
                                    <input className="appearance-none block w-full  text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" value={formState.cidade}onChange={(event)=>setFormState({...formState,cidade:event.currentTarget?.value ||""})}placeholder="Digite rua,número e bairro"/>
                                ...
                                <div className="w-full md:w-1/6  pt-4 px-3">
                                    ...
                                    <input className="appearance-none block w-full  text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" value={formState.cidade}onChange={(event)=>setFormState({...formState,cidade:event.currentTarget?.value ||""})}placeholder="UF"/>
