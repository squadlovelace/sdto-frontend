                    ...
                    <form onSubmit={handleSubmit}>   
                        <div className="flex flex-wrap -mx-3 mb-6">
                            <div className="w-full px-3 mb-6 md:mb-0 pt-4">
                                ...
                                <input className="appearance-none block w-full  text-gray-700 border rounded-lg py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name=""id="grid-first-name" type="text" value={formState.nome}onChange={(event)=>setFormState({...formState,nome:event.currentTarget?.value ||""})}placeholder="Digite seu nome"/>
                            </div>
                            <div className="w-full md:w-1/2 px-3 pt-4">
                                <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                <p style={{color:"#672557"}}>Email</p>
                                </label>
                                <input className="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" name="cnpj"placeholder="Digite Seu Email" value={formState.email}onChange={(event)=>setFormState({...formState,email:event.currentTarget?.value ||""})}/>
                                ...
                                <div className="w-full md:w-1/2  pt-4 px-3">
                                    ...
                                    <input className="appearance-none block w-full  text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Digite a cidade onde localiza-se a instituição"/>
                                ...
                                <div className="w-full md:w-1/2 pt-4 px-3">
                                    ...
                                    <input className="appearance-none block w-full  text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" value={formState.rg}onChange={(event)=>setFormState({...formState,rg:event.currentTarget?.value ||""})}placeholder="Digite rua,número e bairro"/>
                                ...
                                <div className="w-full md:w-1/2  pt-4 px-3">
                                    ...
                                    <input className="appearance-none block w-full  text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" value={formState.cpf}onChange={(event)=>setFormState({...formState,cpf:event.currentTarget?.value ||""})}placeholder="CPF"/>
